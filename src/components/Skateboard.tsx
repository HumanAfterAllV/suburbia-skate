...
export function Skateboard(props: skateboardTypes) {
  const { nodes } = useGLTF('/skateboard.gltf') as GLTFResult

  const gripTapeDiffuse = useTexture("/skateboard/griptape-diffuse.webp")
  const gripTaperRoughness = useTexture("/skateboard/griptape-roughness.webp")

  const gripTapeMaterial = useMemo(() => {
    const material = new THREE.MeshStandardMaterial({
        map: gripTapeDiffuse,
        bumpMap: gripTaperRoughness,
        roughnessMap: gripTaperRoughness,
        bumpScale: 3.5,
        roughness: 0.8,
        color: "#555555"
    })
    ...
    if(gripTapeDiffuse){
        ...
        gripTaperRoughness.wrapS = THREE.RepeatWrapping;
        gripTaperRoughness.wrapT = THREE.RepeatWrapping;
        gripTaperRoughness.repeat.set(9, 9);
        gripTaperRoughness.needsUpdate = true;

        gripTaperRoughness.anisotropy = 8;
    }

    
        return material
    }, [gripTapeDiffuse, gripTaperRoughness])
