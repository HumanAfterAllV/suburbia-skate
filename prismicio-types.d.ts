...
export interface TextAndImageSliceDefaultPrimary {
  ...
  /**
   * Background Texture field in *TextAndImage → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.default.primary.background_texture
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  background_texture: prismic.ImageField<never>;
...
export interface TextAndImageSliceImageOnLeftPrimary {
  ...
  /**
   * Background Texture field in *TextAndImage → Image on left → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: text_and_image.imageOnLeft.primary.background_texture
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  background_texture: prismic.ImageField<never>;
